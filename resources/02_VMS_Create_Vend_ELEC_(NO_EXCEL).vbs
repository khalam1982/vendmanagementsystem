...
If A < 10 Then
	...
	sSQLCmd1 = "insert into METER_DETAILS (MSN,PPKEY,FUELTYPE) VALUES('MSN20000" & A & ",'20000000000000" & A & "','ELECTRIC')"
...
Elseif A < 100 Then
	...
	sSQLCmd1 = "insert into METER_DETAILS (MSN,PPKEY,FUELTYPE) VALUES('MSN2000" & A & "','2000000000000" & A & "','ELECTRIC')"
	iRetVal1=GetDatabaseValue1("CNRV0046","TVCPPY04","PREPAY_APP_USER","trespa55","1526",sSQLCmd1)
	sData1 = ""
...
Elseif A < 1000 Then
	...
	sSQLCmd1 = "insert into METER_DETAILS (MSN,PPKEY,FUELTYPE) VALUES('MSN200" & A & "','200000000000" & A & "','ELECTRIC')"
	iRetVal1=GetDatabaseValue1("CNRV0046","TVCPPY04","PREPAY_APP_USER","trespa55","1526",sSQLCmd1)
	sData1 = ""
...
Elseif A < 10000 Then
	...
	sSQLCmd1 = "insert into METER_DETAILS (MSN,PPKEY,FUELTYPE) VALUES('MSN20" & A & "','20000000000" & A & "','ELECTRIC')"
	iRetVal1=GetDatabaseValue1("CNRV0046","TVCPPY04","PREPAY_APP_USER","trespa55","1526",sSQLCmd1)
	sData1 = ""
