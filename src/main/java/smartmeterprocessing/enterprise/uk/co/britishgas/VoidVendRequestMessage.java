 ...
 */
            ...
            /**
            *  VoidVendRequestMessage bean class
            */
        
        public  class VoidVendRequestMessage
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = VoidVendRequestMessage
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for VendRequestPAN
                        */

                        
                                    protected smartmeterprocessing.enterprise.uk.co.britishgas.PanNumber localVendRequestPAN ;
                           ...
                           */
                           public  smartmeterprocessing.enterprise.uk.co.britishgas.PanNumber getVendRequestPAN(){
                               return localVendRequestPAN;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param VendRequestPAN
                               */
                               public void setVendRequestPAN(smartmeterprocessing.enterprise.uk.co.britishgas.PanNumber param){
                            
                                            this.localVendRequestPAN=param;
                        ...
                        /**
                        * field for VendRequestMSN
                        */

                        
                                    protected meter.enterprise.uk.co.britishgas.MeteringAssetBasic localVendRequestMSN ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localVendRequestMSNTracker = false ;
                           ...
                           */
                           public  meter.enterprise.uk.co.britishgas.MeteringAssetBasic getVendRequestMSN(){
                               return localVendRequestMSN;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param VendRequestMSN
                               */
                               public void setVendRequestMSN(meter.enterprise.uk.co.britishgas.MeteringAssetBasic param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localVendRequestMSNTracker = true;
                                       } else {
                                          localVendRequestMSNTracker = false;
                                              
                                       }
                                   
                                            this.localVendRequestMSN=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       VoidVendRequestMessage.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VoidVendRequestMessage",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VoidVendRequestMessage",
                           xmlWriter);
                   }
                                           ...
                                           localVendRequestKey.serialize(new javax.xml.namespace.QName("","VendRequestKey"),
                                            ...
                                            if (localVendRequestPAN==null){
                                                 throw new org.apache.axis2.databinding.ADBException("VendRequestPAN cannot be null!!");
                                            }
                                           localVendRequestPAN.serialize(new javax.xml.namespace.QName("","VendRequestPAN"),
                                               factory,xmlWriter);
                                         if (localVendRequestMSNTracker){
                                            if (localVendRequestMSN==null){
                                                 throw new org.apache.axis2.databinding.ADBException("VendRequestMSN cannot be null!!");
                                            }
                                           localVendRequestMSN.serialize(new javax.xml.namespace.QName("","VendRequestMSN"),
                                               factory,xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localVendRequestPAN);
                                 if (localVendRequestMSNTracker){
                            elementList.add(new javax.xml.namespace.QName("",
                                                                      "VendRequestMSN"));
                                    ...
                                    elementList.add(localVendRequestMSN);
                                }
                            elementList.add(new javax.xml.namespace.QName("",
    ...
    public static class Factory{
        ...
        */
        public static VoidVendRequestMessage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VoidVendRequestMessage object =
                new VoidVendRequestMessage();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VoidVendRequestMessage".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VoidVendRequestMessage)smartmeterprocessing.enterprise.uk.co.britishgas.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","VendRequestPAN").equals(reader.getName())){
                                
                                                object.setVendRequestPAN(smartmeterprocessing.enterprise.uk.co.britishgas.PanNumber.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","VendRequestMSN").equals(reader.getName())){
                                
                                                object.setVendRequestMSN(meter.enterprise.uk.co.britishgas.MeteringAssetBasic.Factory.parse(reader));
