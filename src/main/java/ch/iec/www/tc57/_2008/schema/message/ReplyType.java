 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localReplyCode ;
                           ...
                           */
                           public  java.lang.String getReplyCode(){
                            ...
                            /**
                               ...
                               * @param param ReplyCode
                               */
                               public void setReplyCode(java.lang.String param){
                            
                                            this.localReplyCode=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ReplyType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ReplyCode", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ReplyCode");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("ReplyCode");
                                          ...
                                          if (localReplyCode==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("ReplyCode cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localReplyCode);
                                            ...
                                            if (localError[i] != null){
                                                ...
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        ...
                                                        xmlWriter.writeStartElement(prefix2,"Error", namespace);
                                                    ...
                                                    xmlWriter.writeStartElement("Error");
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localError[i]));
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.iec.ch/TC57/2008/schema/message",
                                        ...
                                        if (localReplyCode != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localReplyCode));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("ReplyCode cannot be null!!");
                                        }
                                     if (localErrorTracker){
    ...
    public static class Factory{
        ...
        */
        public static ReplyType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReplyType object =
                new ReplyType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReplyType".equals(type)){
                                ...
                                return (ReplyType)ch.iec.www.tc57._2008.schema.message.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.iec.ch/TC57/2008/schema/message","ReplyCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.iec.ch/TC57/2008/schema/message","Error").equals(reader.getName())){
                                    ...
                                    list2.add(reader.getElementText());
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://www.iec.ch/TC57/2008/schema/message","Error").equals(reader.getName())){
                                                         list2.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setError((java.lang.String[])
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.iec.ch/TC57/2008/schema/message","ID").equals(reader.getName())){
                                    ...
                                    list3.add(reader.getElementText());
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://www.iec.ch/TC57/2008/schema/message","ID").equals(reader.getName())){
                                                         list3.add(reader.getElementText());
