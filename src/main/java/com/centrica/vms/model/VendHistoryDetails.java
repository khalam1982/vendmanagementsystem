...
/**
 * Methods for vend history details
 * @see VendTransaction
 */
public class VendHistoryDetails extends VendTransaction{
	...
	/**
	 * Getter method to fill empty value if any other column is empty to avoid null value for defined tag
