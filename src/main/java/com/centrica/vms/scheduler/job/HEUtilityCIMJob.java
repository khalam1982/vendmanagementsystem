/**
 * HEUtilityCIMJob.java
 * Purpose: Head end utility job for CIM service (void adjustment)
 * @author nagarajk
 */
...
/**
 * Methods for Head end CIM utility job
 * @see VMSJob
 */
public class HEUtilityCIMJob extends VMSJob {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		try  {
			...
			IHEMessageService vmsUtilityService = new HEMessageCIMService(getURL(vendServiceDetails));
	...
	private URL getURL(VendServiceDetails vendServiceDetails)
			throws MalformedURLException {
		if (vendServiceDetails != null && vendServiceDetails.getUrl() != null && !vendServiceDetails.getUrl().contains("HES_IP")) {
			return new URL(vendServiceDetails.getUrl());
		} 
		return null;
	}
