 ...
 * @see VMSJob
 */
public class HEUtilityPhase3Job extends VMSJob {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		try  {
			...
			IHEMessageService vmsUtilityService = new HEMessagePhase3Service(getURL(vendServiceDetails));
