...
public class BusinessProcessingFaultException0 extends java.lang.Exception{
    ...
    private com.centrica.vms.ws.transaction.query.BusinessProcessingFault faultMessage;
    ...
    public void setFaultMessage(com.centrica.vms.ws.transaction.query.BusinessProcessingFault msg){
       faultMessage = msg;
    }
    
    public com.centrica.vms.ws.transaction.query.BusinessProcessingFault getFaultMessage(){
       return faultMessage;
    }
}
