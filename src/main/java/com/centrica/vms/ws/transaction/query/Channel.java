 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Channel.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                if (localChannelTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"Channel", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"Channel");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static Channel parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Channel object =
                new Channel();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Channel".equals(type)){
                                ...
                                return (Channel)com.centrica.vms.ws.transaction.query.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
