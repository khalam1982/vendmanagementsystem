/**
 * AckRequestDispatchAction.java
 * Purpose: Class to send ACK request dispatch action
 *
 * @author nagarajk
 */
 ...
 */
public class AckRequestDispatchAction extends VMSDispatchAction {
	...
	public ActionForward confirm(ActionMapping mapping, ActionForm form,
		...
		String loggedUser = (String)request.getSession(false).getAttribute("USERNAME");
		logger.info(Logger.EVENT_UNSPECIFIED,"Logged in User name" +loggedUser);
		AckRequestDetailsForm  ackRequestDetailsForm = (AckRequestDetailsForm)form;
		VMSWebActionDelegate vmswebActionDelegate = new VMSWebActionDelegate();
		ackRequestDetailsForm = vmswebActionDelegate.sendAckRequest(ackRequestDetailsForm);
