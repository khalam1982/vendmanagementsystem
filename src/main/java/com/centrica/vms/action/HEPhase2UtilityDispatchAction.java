/**
 * HEPhase2UtilityDispatchAction.java
 ...
 */
public class HEPhase2UtilityDispatchAction extends VMSUtilityDispatchAction {
	...
	private ActionForward heDetailRequest(ActionMapping mapping, ActionForm form,String userName){
		...
		Integer count = vmsWebActionDelegate.getResendTransactionCount(userName, 0);
		utilityRequestForm.setCount(count.toString());
		ActionForward actionForward =  mapping.findForward("hePhase2Request");
	...
	public ActionForward heConfirmPage(ActionMapping mapping, ActionForm form,
		...
		Integer processStatus = vmsWebActionDelegate.scheduleHEUtility(heUtilityRequestForm, DeviceTypeEnum.PH2B.getDeviceType());
