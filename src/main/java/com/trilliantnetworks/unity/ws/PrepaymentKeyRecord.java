...
public class PrepaymentKeyRecord
implements org.apache.axis2.databinding.ADBBean {

    /* This type was generated from the piece of schema that had
            name = PrepaymentKeyRecord
    ...
    private static java.lang.String generatePrefix(java.lang.String namespace) {
        ...
        return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                    ...
                    */
                    ...
                    /**
                    * field for PrepaymentKey
                    */

                    
                                protected java.lang.String localPrepaymentKey ;
                       ...
                       * @return java.lang.String
                       */
                       public  java.lang.String getPrepaymentKey(){
                           return localPrepaymentKey;
                       }
                        ...
                        /**
                           * Auto generated setter method
                           * @param param PrepaymentKey
                           */
                           public void setPrepaymentKey(java.lang.String param){
                        
                                        this.localPrepaymentKey=param;
   ...
   public org.apache.axiom.om.OMElement getOMElement (
           ...
           org.apache.axiom.om.OMDataSource dataSource =
             ...
             public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                   PrepaymentKeyRecord.this.serialize(parentQName,factory,xmlWriter);
             }
           };
              ...
              if (serializeType){
               ...
               if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                   writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                       namespacePrefix+":PrepaymentKeyRecord",
                       xmlWriter);
               } else {
                   writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                       "PrepaymentKeyRecord",
                               ...
                               xmlWriter.writeEndElement();
                                ...
                                if (! namespace.equals("")) {
                                    ...
                                    if (prefix == null) {
                                        ...
                                        xmlWriter.writeStartElement(prefix,"prepaymentKey", namespace);
                                        xmlWriter.writeNamespace(prefix, namespace);
                                        xmlWriter.setPrefix(prefix, namespace);

                                    } else {
                                        xmlWriter.writeStartElement(namespace,"prepaymentKey");
                                    }

                                } else {
                                    xmlWriter.writeStartElement("prepaymentKey");
                                }
                            

                                      if (localPrepaymentKey==null){
                                          // write the nil attribute
                                          
                                                 throw new org.apache.axis2.databinding.ADBException("prepaymentKey cannot be null!!");
                                              
                                      }else{

                                    
                                               xmlWriter.writeCharacters(localPrepaymentKey);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
             ...
             java.util.ArrayList attribList = new java.util.ArrayList();
                                  ...
                                  elementList.add(new javax.xml.namespace.QName("urn:prepay.ws.unity.trilliantnetworks.com",
                                    ...
                                    if (localPrepaymentKey != null){
                                        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPrepaymentKey));
                                    } else {
                                       throw new org.apache.axis2.databinding.ADBException("prepaymentKey cannot be null!!");
                                    }
...
public static class Factory{
    ...
    */
    public static PrepaymentKeyRecord parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
        PrepaymentKeyRecord object =
            new PrepaymentKeyRecord();
        ...
        try {
            ...
            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
              ...
              if (fullTypeName!=null){
                ...
                java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                        ...
                        if (!"PrepaymentKeyRecord".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (PrepaymentKeyRecord)ExtensionMapper.getTypeObject(
                                 nsUri,type,reader);
                          }
            ...
            java.util.Vector handledAttributes = new java.util.Vector();
                ...
                reader.next();
                                ...
                                if (reader.isStartElement() && new javax.xml.namespace.QName("urn:prepay.ws.unity.trilliantnetworks.com","prepaymentKey").equals(reader.getName())){
                            
                                java.lang.String content = reader.getElementText();
                                
                                          object.setPrepaymentKey(
                                                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
