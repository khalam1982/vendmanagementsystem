...
<title>Void Vend Response Details Page</title>
<style type="text/css">
label {
	padding-left: 25em;
	font-family: Arial;
...
<html:form action="/VoidVendRequestAction" onsubmit="javascript:submitPage()">
	<table border=1>
		<tr>
		...
		<tr>
			...
			<td><bean:write name="VoidVendRequestForm" property="statusCode" /></td>
		</tr>
		<tr>
			<td><bean:message key="app.description" />:</td>
			<td><bean:write name="VoidVendRequestForm" property="description" /></td>
		</tr>
		<tr>
