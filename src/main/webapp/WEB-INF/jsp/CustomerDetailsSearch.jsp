...
<title>Customer Details Search Page</title>
<style type="text/css">
label {
	padding-left: 25em;
	font-family: Arial;
...
<script language="javascript">
	function submitPage() {
		document.forms[0].action = "CustomerDispatchSearchAction";
	}
...
<html:form action="/CustomerDispatchSearchAction" >
	<table border=1>
		<tr>
			<td><bean:message key="app.pan" /><font color="red">*</font>:</td>
			<td><html:text property="pan" onkeypress="javascript:submitPage()"></html:text></td>
		</tr>
		<tr>
